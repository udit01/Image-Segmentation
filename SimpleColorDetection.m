...
try
    ...
    message = sprintf('Now to thredhold by sliders.');
    ...
    [lowThreshold, highThreshold] = threshold(greenThresholdLow, greenThresholdHigh, rgbImage);
    %====================== KEY PART RIGHT HERE!!!! ===================================================
    
    redThresholdLow = lowThreshold ;
    greenThresholdLow = lowThreshold ;
    blueThresholdLow = lowThreshold ;
    
    redThresholdHigh = highThreshold ;
    greenThresholdHigh = highThreshold ;
    blueThresholdHigh = highThreshold ;
